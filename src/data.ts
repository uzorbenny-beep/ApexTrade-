...
export const initialAssets: Asset[] = [
  ...
  },
  {
    ...
    name: 'USD / CHF',
    type: 'forex',
    currentPrice: 0.88450,
    initialPrice: 0.88610,
    change24h: -0.18,
    leverageMax: 500,
    spread: 0.00012,
    history: generateHistoricalCandles(0.88450, 40, 0.001),
  },
  {
    id: 'NZDUSD',
    name: 'NZD / USD',
    type: 'forex',
    currentPrice: 0.61220,
    initialPrice: 0.61110,
    change24h: 0.18,
    leverageMax: 500,
    spread: 0.00015,
    history: generateHistoricalCandles(0.61220, 40, 0.001),
  },
  {
    id: 'XAUUSD',
    name: 'Gold Spot / USD',
